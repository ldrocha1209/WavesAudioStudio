...
Waves v1.0 targets the owner's Intel Mac running macOS 14 or newer. The architecture keeps React, Rust host integration, and Python processing separated, but no Windows or Apple Silicon release claim is made.
